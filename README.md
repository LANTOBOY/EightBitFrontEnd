...
## 메인페이지
- 사용자 처음 보게 될 메인페이지입니다. Swiper 라이브러리로 슬라이드를 구현하여 사용자가 편히 볼 수 있도록 개발.
...
## 로그인/회원가입 페이지
- 사용자가 로그인 및 회원가입을 할 수 있는 페이지입니다. JavaScript를 활용하여 로그인/회원가입 기능 구현.
<img width="100%" src="https://github.com/LANTOBOY/EightBitFrontend/assets/114972796/07d6eea3-acfe-4741-853e-46f6eeb7953d" />

## 공식게임 페이지
- 8bit를 대표하는 공식게임을 소개해주는 페이지입니다. CSS3를 활용하여 마우스 호버 시 게임이 밝아지면서 3D처럼 튀어나오도록 구현.
<img width="100%" src="https://github.com/LANTOBOY/EightBitFrontend/assets/114972796/1aba1b1d-26d6-4369-9d82-a17676fcac61" />
<img width="100%" src="https://github.com/LANTOBOY/EightBitFrontend/assets/114972796/785d3bb2-47cc-4736-b7da-f710f4b114cf" />

## 인디게임,굿즈샵,쿠폰샵 페이지
- 사용자가 더욱 편리하게 인디게임,굿즈,쿠폰을 볼 수 있는 페이지입니다. JavaScript를 활용하여 검색/필터 기능을 구현.
...
- 상품이나 게임을 클릭하면 상세정보를 보여주고 다운로드/구매가 가능한 페이지입니다. CSS3를 활용하여 구현.
...
## 게시판/글쓰기 페이지
- 사용자가 각종 자유/공식/공략 등등 유저들이 올리는 게시글 리스트를 볼 수 있고 작성할 수 있는 페이지입니다. JavaScript,CSS3를 활용하여 대 댓글,좋아요,파일첨부 기능 구현.
...
## 게임 개발자 업로드 페이지
- 게임을 개발하고 올릴 수 있는 페이지입니다. JavaScript,CSS3를 활용하여 이미지/파일 업로드 기능 구현.
...
## 모바일/테블릿 반응형, 모달창 구현
- 사용자가 태블릿 및 모바일로 접속하면 사이트가 깨지는 것을 막기 위해 반응형으로 구현하고 딱딱한  보다는 부드러운 모달창으로 구현.
